...
Most of this code is following along with learnopengl.com's tutorial on mesh loading from assimp. Given that we might want to use
their tutorial on changing it to allow skinned animation later!! Go read the original tutorial for explaination of what's going on
in here..
